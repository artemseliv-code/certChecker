    ...
    public String getMetrics() {
       ...
       // метрика файлоы jks и pem
        ...
        try {
            ...
            metrics.append("certificate_files_count{type=\"jks\", ").append(jksCount).append(getHostname()).append(" }").append("\n");

            metrics.append("certificate_files_count{type=\"pem\", ").append(pemCount).append(getHostname()).append(" }").append("\n");
        } catch (Exception e) {
